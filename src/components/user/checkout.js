                ...
                <div className="col-md-8">
                    <div className="product-content-right">
                        ...
                        <input type="checkbox" value="1" name="ship_to_different_address" checked="checked" className="input-checkbox" id="ship-to-different-address-checkbox"/>
                                            ...
                                            <div className="shipping_address" styles="display: block;">
                                ...
                                <div id="order_review" styles="position: relative;">
                                    ...
                                    <div id="payment">
                                        <ul className="payment_methods methods">
                                            ...
                                            <li className="payment_method_cheque">
                                                ...
                                                <div styles="display:none;" className="payment_box payment_method_cheque">
                                            ...
                                            <li className="payment_method_paypal">
                                                ...
                                                <div styles="display:none;" className="payment_box payment_method_paypal">
