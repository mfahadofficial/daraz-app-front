            ...
            <div className="row">
                ...
                <div className="navbar-collapse collapse">
                    <ul className="nav navbar-nav">
                        ...
                        <li className="active"><a href="cart.html">Cart</a></li>
                ...
                <div className="col-md-4">
                    ...
                    <div className="single-sidebar">
                        ...
                        <div className="thubmnail-recent">
                            <img src="uStoreStyle/img/product-thumb-1.jpg" className="recent-thumb" alt=""></img>
                                    ...
                                    <tbody>
                                        <tr className="cart_item">
                                            ...
                                            <td className="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" className="shop_thumbnail" src="uStoreStyle/img/product-thumb-2.jpg"></img></a>
                                            </td>
                                ...
                                <ul className="products">
                                    <li className="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" className="attachment-shop_catalog wp-post-image" src="uStoreStyle/img/product-2.jpg"></img>
                                    ...
                                    <li className="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" className="attachment-shop_catalog wp-post-image" src="uStoreStyle/img/product-4.jpg"></img>
                                            <h3>Ship Your Idea</h3>
                                            <span className="price"><span className="amount">£20.00</span></span>
                                        </a>
