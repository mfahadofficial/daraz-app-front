					...
					<div className="col-lg-2 col-md-6 col-sm-6">
						<div className="single-footer-widget instafeed">
							...
							<ul className="list instafeed d-flex flex-wrap">
								<li><img src="img/gallery/r1.jpg" alt=""></img></li>
								<li><img src="img/gallery/r2.jpg" alt=""></img></li>
								<li><img src="img/gallery/r3.jpg" alt=""></img></li>
								<li><img src="img/gallery/r5.jpg" alt=""></img></li>
								<li><img src="img/gallery/r7.jpg" alt=""></img></li>
								<li><img src="img/gallery/r8.jpg" alt=""></img></li>
							</ul>
						</div>
					</div>
